...
import static jmemorize.core.Category.Events.DECK_EVENT;
...
//      TODO move to CardSide class
    ...
    public Card cloneCard() {
        ...
        try {
            ...
            card.m_frontSide = new CardSide(m_frontSide);
            card.m_backSide = new CardSide(m_backSide);
    ...
    public Card cloneWithoutProgress()
    {
        ...
        return new Card(m_dateCreated, new CardSide(m_frontSide), new CardSide(m_backSide));
