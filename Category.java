...
public class Category
{
    ...
    public void addCard(Card card, int level)
    {
        ...
        fireCardEvent(Events.ADDED_EVENT, card, card.getCategory(), level);
    }
    ...
    public void removeCard(Card card)
    {
        ...
        fireCardEvent(Events.REMOVED_EVENT, card, category, level);
    }
    ...
    public static void moveCard(Card card, Category newCategory)
    {
        ...
        category.fireCardEvent(Events.MOVED_EVENT, card, category, level);
        newCategory.fireCardEvent(Events.MOVED_EVENT, card, category, level);
    }
    ...
    public static void reappendCard(Card card)
    {
        ...
        card.getCategory().fireCardEvent(Events.DECK_EVENT, card, card.getCategory(), card.getLevel());
    }
    ...
    public Category addCategoryChild(Category category)
    {
        ...
        fireCategoryEvent(Events.ADDED_EVENT, category);
    ...
    public void remove()
    {
        ...
        fireCategoryEvent(Events.REMOVED_EVENT, this);
    ...
    public void setName(String newName)
    {
        ...
        if (!m_name.equals(newName))
        {
            ...
            fireCategoryEvent(Events.EDITED_EVENT, this);
        }
    }
    ...
    void fireCardEvent(Events type, Card card, Category category, int deck)
    {
        if (type != Events.EDITED_EVENT)
        {
            adjustNumberOfDecks();
        }
        ...
        {
            observer.onCardEvent(type, card, category, deck, type);
        }
    }
    
    void fireCategoryEvent(Events type, Category category)
    {
        adjustNumberOfDecks();
        ...
        Date newTest, Date newExpiration)
    {
        ...
        category.fireCardEvent(Events.DECK_EVENT, card, category, level);
    }
