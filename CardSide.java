...
public class CardSide
{
    ...
    public CardSide(CardSide other) {
        this.m_text = new FormattedText(other.m_text); // FormattedText has a copy constructor
        this.m_imageIDs = new LinkedList<>(other.m_imageIDs);
    }
